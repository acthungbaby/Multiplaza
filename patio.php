...
<body class="bodyPatio">
	...
	<section id="contenedor">
		...
		<img class="" src="<?php echo IMAGE_PATH?>header/comidas.jpg" alt="">

		<?php if (!isset($_GET['s'])) { ?>
		
		<section id="tiendas">
			<a href="patio.php?s=28"><article class="buffet">
				<section class="text">
					<h3>Buffet</h3>
				</section>
			</article></a>
			<a href="patio.php?s=29"><article class="heladeria">
				<section class="text">
					<h3>Cafetería y Heladería</h3>
				</section>
			</article></a>
			<a href="patio.php?s=30"><article class="fast last">
				<section class="text">
					<h3>Fast Food</h3>
				</section>
			</article></a>
			<a href="patio.php?s=31"><article class="pastas">
				<section class="text">
					<h3>Pastas</h3>
				</section>
			</article></a>
			<a href="patio.php?s=32"><article class="picadas">
				<section class="text">
					<h3>Picadas</h3>
				</section>
			</article></a>
		...
		<section id="listadotiendas">
			<h1><a href="patio.php">Patio de Comidas</a> » <span><?php echo htmlentities($seccion['seccion_nombre'], ENT_IGNORE & ENT_HTML5, "ISO-8859-15"); ?></span></h1>
